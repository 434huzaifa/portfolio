...
const Hero = () => {
    return (
        <Card className="mb-5 bg-transparent backdrop-blur-sm">
        <div className="flex md:flex-row flex-col-reverse gap-2 justify-between items-center ">
            <div className="flex flex-col  gap-3 flex-1">
                ...
                <p className="text-gray-300 italic text-justify">I'm Md. Huzaifa, a Fullstack Developer proficient in Django, Flask, Express, React, MySQL, and MongoDB. I graduated with a Bachelor's in Computer Science from East West University in May 2023. Based in Bangladesh, I'm actively seeking job opportunities to apply my skills in innovative projects. My focus is on delivering efficient solutions and contributing to dynamic teams. Excited about the next challenge!</p>
